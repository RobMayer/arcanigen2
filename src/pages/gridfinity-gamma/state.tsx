...
import { FootStyles, GlobalSettings, ItemInstance, ItemType } from "./types";
...
export const useItemList = () => {
    const list = useSnapshot(state).store.items;
    ...
    return [list, methods] as [typeof list, typeof methods];
};
