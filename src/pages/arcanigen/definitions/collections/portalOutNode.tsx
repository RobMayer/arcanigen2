...
import { INodeDefinition, NodeRenderer, INodeHelper, INodeInstance, NodeRendererProps, ControlRendererProps, PortalBus, GraphGlobals, IArcaneGraph, ILinkInstance } from "../types";
...
const PortalOutNodeHelper: INodeHelper<IPortalOutNode> = {
    name: "Portal (Out)",
    buttonIcon: nodeIcons.portalOut.buttonIcon,
    nodeIcon: nodeIcons.portalOut.nodeIcon,
    flavour: "danger",
