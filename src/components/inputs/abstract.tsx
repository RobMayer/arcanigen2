...
export type SimpleInputProps<T, E extends HTMLElement = HTMLInputElement> = AbstractInputProps<T, E> & Omit<DetailedHTMLProps<InputHTMLAttributes<E>, E>, "value" | "onChange">;
