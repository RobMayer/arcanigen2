        ...
        <BaseNode<IConvertNode> nodeId={nodeId} helper={ConvertNodeHelper} hooks={nodeHelper}>
            ...
            >
                ...
                <BaseNode.Input label={"Unit"}>
                    <NativeDropdown value={numberToLengthUnit} options={UNIT_OPTIONS} onSelect={setNumberToLengthUnit} />
                </BaseNode.Input>
                <hr />
                ...
                <SocketIn<IConvertNode> nodeId={nodeId} socketId={"numberToPercentLower"} type={SocketTypes.NUMBER}>
                    <BaseNode.Input label={"Lower Bound"}>
                        <NumericInput value={numberToPercentLower} onValidValue={setNumberToPercentLower} max={actualPercentUpper ?? numberToPercentUpper} disabled={hasNumberToPercentLower} />
                    </BaseNode.Input>
                </SocketIn>
                <SocketIn<IConvertNode> nodeId={nodeId} socketId={"numberToPercentUpper"} type={SocketTypes.NUMBER}>
                    <BaseNode.Input label={"Upper Bound"}>
                        <NumericInput value={numberToPercentUpper} onValidValue={setNumberToPercentUpper} min={actualPercentLower ?? numberToPercentLower} disabled={hasNumberToPercentUpper} />
                    </BaseNode.Input>
                </SocketIn>
            </BaseNode.Foldout>
            <BaseNode.Foldout panelId={"fromPercent"} label={"Percent"} nodeId={nodeId} inputs={"inputPercent"} outputs={"percentToCentigrade percentToHectograde"} startOpen>
            ...
            <BaseNode.Foldout panelId={"fromAngle"} label={"Angle"} nodeId={nodeId} inputs={"inputAngle"} outputs={"angleToDegrees angleToRadians angleToTurns"} startOpen>
            ...
            <BaseNode.Foldout panelId={"fromLength"} label={"Length"} nodeId={nodeId} inputs={"inputLength"} outputs={"lengthToPx lengthToPt lengthToIn lengthToCm lengthToMm"} startOpen>
...
const ConvertNodeHelper: INodeHelper<IConvertNode> = {
    name: "Convert Value",
    buttonIcon: nodeIcons.convert.buttonIcon,
    nodeIcon: nodeIcons.convert.nodeIcon,
    flavour: "help",
