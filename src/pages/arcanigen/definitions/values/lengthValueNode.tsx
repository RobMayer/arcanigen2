...
const Controls = memo(({ nodeId, globals }: ControlRendererProps) => {
    ...
    return (
        <BaseNode<ILengthValueNode> nodeId={nodeId} helper={LengthValueNodeHelper} hooks={nodeHooks}>
            ...
            <BaseNode.Foldout panelId={"units"} nodeId={nodeId} inputs={""} outputs={"lengthToPx lengthToPt lengthToIn lengthToCm lengthToMm"} label={"Additional Outputs"}>
...
const LengthValueNodeHelper: INodeHelper<ILengthValueNode> = {
    name: "Length",
    buttonIcon: nodeIcons.lengthValue.buttonIcon,
    nodeIcon: nodeIcons.lengthValue.nodeIcon,
    flavour: "help",
