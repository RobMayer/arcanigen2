        ...
        <BaseNode<IColorHSLNode> nodeId={nodeId} helper={ColorHSLNodeHelper} hooks={nodeHooks}>
            ...
            <SocketIn<IColorHSLNode> nodeId={nodeId} socketId={"lIn"} type={SocketTypes.PERCENT}>
                <BaseNode.Input label={"Lightness"}>
                    <SliderInputOld min={0} max={1} value={l} onValidValue={setL} disabled={hasLIn} />
                </BaseNode.Input>
            </SocketIn>
...
const getOutput = (graph: IArcaneGraph, nodeId: string, socket: keyof IColorHSLNode["outputs"], globals: GraphGlobals) => {
