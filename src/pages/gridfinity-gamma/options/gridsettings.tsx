...
export const GlobalSettings = () => {
    ...
    const [isGlobalOpen, setIsGlobalOpen] = useUIState("grinfinitygamma.itms.global.settings", true);

    return (
        <>
            <Section>Settings</Section>
            <ControlledFoldout isOpen={isGlobalOpen} onToggle={setIsGlobalOpen} label={"Global Settings"}>
                <ControlPanel>
...
const LayoutSettings = () => {
    const [value, setValue] = useGlobalSettings();
    const [isOpen, setIsOpen] = useUIState("grinfinitygamma.items.global.layout", true);
