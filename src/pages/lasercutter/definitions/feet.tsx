...
const getLayout = (item: FeetParams, material: Material, grid: GridSystem) => {
    ...
    const stackClearance = convertLength(grid.footClearance, "mm").value;
    ...
    switch (grid.footStyle) {
        ...
        case "BLOCK":
            return [
                { width: gridSize - materialThickness - stackClearance - gridClearance, height: gridSize - materialThickness - stackClearance - gridClearance, path: drawFootBlock(material, grid) },
            ];
        case "BRACKET":
